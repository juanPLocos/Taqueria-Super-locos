...
<html lang="en">
 ...
 <body class="goto-here container">
 	...
 	<ul class="nav magnific-popup">
						...
						<li><p style="color:black";>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Bienvenido: <strong><?php echo $_SESSION['user'];?></strong></p></li> 
...
<!--///////////////////////////////////////////////////Empieza cuerpo del documento interno////////////////////////////////////////////-->
		<center><h2>Ordenes Realizadas</h2></center>	
			...
			<?php 
				 while($arreglo=mysqli_fetch_array($query)){
				  	echo "<tr class='success'>";
				    	...
				    	echo "<td><a href='ActualizarOrden.php?id=$arreglo[0]'><img src='images/actualizar.png' class='img-rounded'></td>";
