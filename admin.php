 ...
 <body class="goto-here container">
 	...
 	<ul class="nav magnific-popup">
						...
						<li><p style="color:black";>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Bienvenido: <strong></strong></p></li> 
			 			<li><a href="index.html"><p style="color:black";> <strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Cerrar Sesión </strong></p></a></li>
			 			...
			 			<li><a href="RegistroRepartidor.php"><p style="color:black";> <strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Registrar Repartidor </strong></p></a></li>
...
//la variable  $mysqli viene de connect_db que lo traigo con el require("connect_db.php");
				...
				echo "<table border='1'; class='table table-bordered';>";
					echo "<tr class='warning'>";
						...
						echo "<td>Password del repartidor</td>";
						echo "<td>Editar</td>";
						echo "<td>Borrar</td>";
					echo "</tr>";
			...
			<?php 
				 while($arreglo=mysqli_fetch_array($query)){
				  	echo "<tr class='success'>";
						...
						echo "<td><a href='admin.php?id=$arreglo[0]&idborrar=2'><img src='images/boteB.png' class='img-rounded'/></a></td>";
