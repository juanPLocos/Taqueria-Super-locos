...
<!--///////////////////////////////////////////////////Empieza cuerpo del documento interno////////////////////////////////////////////-->
		<center><h2> Administración de los reportes registrados</h2></center>	
		<div class="well well-small">
		<hr class="soft"/>
		<center><h4>Tabla de Reportes</h4></center>
		<div class="row-fluid">
...
//la variable  $mysqli viene de connect_db que lo traigo con el require("connect_db.php");
				...
				echo "<table border='1'; class='table table-bordered';>";
					echo "<tr class='warning'>";
						echo "<td>Clave_Reporte</td>";
						echo "<td>Nombre</td>";
						echo "<td>Apellidos(s)</td>";
						echo "<td>Correo</td>";
						echo "<td>Asunto</td>";
						echo "<td>Borrar</td>";
					echo "</tr>";
			...
			<?php 
				 while($arreglo=mysqli_fetch_array($query)){
				  	echo "<tr class='success'>";
						...
						echo "<td><a href='ReportesContacto.php?id=$arreglo[0]&idborrar=2'><img src='images/boteB.png' class='img-rounded'/></a></td>";
				...
				echo "</table>";
					...
					if(@$idborrar==2){
						...
						$sqlborrar="DELETE FROM contacto WHERE Clave_Contacto=$id";
						$resborrar=mysqli_query($mysqli,$sqlborrar);
						echo '<script>alert("REGISTRO ELIMINADO")</script> ';
						//header('Location: proyectos.php');
						echo "<script>location.href='ReportesContacto.php'</script>";
					}
